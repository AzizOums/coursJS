...
// Ajout du nouvel élément avant l'element identifié par "php"
document.getElementById("langages").insertBefore(perlElt, 
    document.getElementById("php"));

// Ajout d'un élément au tout début de la liste
document.getElementById('langages').insertAdjacentHTML("afterBegin", /*afterBegin, aftereEnd, beforeBegin, beforeEnd*/
    '<li id="javascript">JavaScript</li>');

//remlacement d'un element
...
document.getElementById("contenu").insertAdjacentHTML("beforeEnd", "<p> En voici une <a href=\"https://fr.wikipedia.org/wiki/Liste_des_langages_de_programmation\">liste</a> plus complète");